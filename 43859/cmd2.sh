...
#   rm -rf out*.o
#   clang++ -g -c -O1 $FILE $INCLUDE -mllvm -opt-bisect-limit=$((NUM-1)) -o out1.o 2>log1
#   clang++ -g -c -O1 $FILE $INCLUDE -mllvm -opt-bisect-limit=$NUM -o out2.o 2>log2
#   objdump -d -j .text out1.o > out1.obj
#   objdump -d -j .text out2.o > out2.obj
...
### Debug1
 NUM1=5445
 NUM0=$((NUM1-4))
 clang++ -S -O1 $FILE $INCLUDE -mllvm -opt-bisect-limit=$NUM0 -o out3.s 2>log3
 clang++ -S -g -O1 $FILE $INCLUDE -mllvm -opt-bisect-limit=$NUM1 -o out3.s 2>log4
