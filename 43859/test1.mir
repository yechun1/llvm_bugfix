...
9:                                                ; preds = %5
  ...
  %11 = load %class.CInBuffer*, %class.CInBuffer** %10, align 8, !tbaa !30
  ...
  store i8 %12, i8* %13, align 4, !tbaa !31
  store i32 8, i32* %6, align 8, !tbaa !28
  br label %14

14:                                               ; preds = %9, %5
  %15 = load i32, i32* %6, align 8, !tbaa !28
...
60:                                               ; preds = %58
  ...
  %64 = add i64 %62, %63
  store i64 %64, i64* %6, align 8, !tbaa !37
...
75:                                               ; preds = %73
  ...
  store i32 %41, i32* %76, align 8, !tbaa !24
...
100:                                              ; preds = %98
  %101 = load i64, i64* %6, align 8, !tbaa !37
...
104:                                              ; preds = %100
  ...
  %109 = load i32 (%struct.IArchiveOpenCallback*, i64*, i64*)**, i32 (%struct.IArchiveOpenCallback*, i64*, i64*)*** %108, align 8, !tbaa !38
...
116:                                              ; preds = %104
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %.lcssa84) #13
  br label %123
...
8:                                                ; preds = %6
  ...
  store i32 1, i32* %10, align 16, !tbaa !2
  call void @__cxa_throw(i8* %9, i8* bitcast (i8** @_ZTIi to i8*), i8* null) #16
  unreachable
...
22:                                               ; preds = %21, %17
  store i8* %.0, i8** %18, align 8, !tbaa !42
...
16:                                               ; preds = %14
  %17 = load i8*, i8** %6, align 8, !tbaa !32
  %18 = zext i32 %2 to i64
  %19 = getelementptr inbounds i8, i8* %17, i64 %18
  store i8* %19, i8** %6, align 8, !tbaa !32
  br label %47

20:                                               ; preds = %14
  %21 = load i8*, i8** %6, align 8, !tbaa !32
  %22 = zext i32 %.022 to i64
  %23 = getelementptr inbounds i8, i8* %21, i64 %22
  %24 = load i8, i8* %23, align 1, !tbaa !23
  %25 = getelementptr inbounds i8, i8* %1, i64 %22
  store i8 %24, i8* %25, align 1, !tbaa !23
  %26 = add i32 %.022, 1
  br label %14
...
31:                                               ; preds = %28
  %32 = load i8*, i8** %6, align 8, !tbaa !32
  %33 = load i8*, i8** %4, align 8, !tbaa !36
...
38:                                               ; preds = %18
  ...
  %40 = load i32 (%struct.IArchiveExtractCallback*, i64)**, i32 (%struct.IArchiveExtractCallback*, i64)*** %39, align 8, !tbaa !38
...
97:                                               ; preds = %93
  ...
  %104 = load i32 (%struct.IArchiveExtractCallback*, i32, %struct.ISequentialOutStream**, i32)**, i32 (%struct.IArchiveExtractCallback*, i32, %struct.ISequentialOutStream**, i32)*** %103, align 8, !tbaa !38
...
129:                                              ; preds = %122, %121
  ...
  %131 = load i32 (%struct.IArchiveExtractCallback*, i32)**, i32 (%struct.IArchiveExtractCallback*, i32)*** %130, align 8, !tbaa !38
...
162:                                              ; preds = %161
  %163 = load i32 (%struct.IArchiveExtractCallback*, i32)**, i32 (%struct.IArchiveExtractCallback*, i32)*** %130, align 8, !tbaa !38
...
188:                                              ; preds = %187, %35
  ...
  %189 = call i32 @llvm.eh.typeid.for(i8* bitcast (i8** @_ZTIPKc to i8*)) #13
...
192:                                              ; preds = %188
  %193 = call i8* @__cxa_begin_catch(i8* %.5107) #13
  %194 = call i8* @__cxa_allocate_exception(i64 8) #13
  %195 = bitcast i8* %194 to i8**
  store i8* %193, i8** %195, align 16, !tbaa !12
  invoke void @__cxa_throw(i8* %194, i8* bitcast (i8** @_ZTIPKc to i8*), i8* null) #16
          to label %203 unwind label %198

196:                                              ; preds = %188
  %197 = call i8* @__cxa_begin_catch(i8* %.5107) #13
  call void @__cxa_end_catch()
  br label %202
...
22:                                               ; preds = %12
  call void @_ZN8NArchive4NSwf4CTagD2Ev(%"struct.NArchive::NSwf::CTag"* %20) #13
...
6:                                                ; preds = %3
  ...
  %14 = load i8, i8* %13, align 1, !tbaa !23
