...
; lower PHI after LABELs will fail, block by dbg_values. To fix this issue, insert
; all dbg_values after both PHIs and Labels in the function ScheduleDAGSDNodes::EmitSchedule, 
; not creating this scenario in the first place to avoid dbg_value impact PHI lowering.
; Fix the issue: https://bugs.llvm.org/show_bug.cgi?id=43859

; The purpose of this case is to check two items:
;   1. reorder dbg_value and insert after label
;   2. phi could lowering after Labels
; before:
;    phi
;    dbg_value
;    label 
