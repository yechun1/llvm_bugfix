...
# 132 vs 137(g)
#clang++ -mllvm -opt-bisect-limit=2 PowerParser.cc -c -O1 -o a.o
#clang++ -mllvm -opt-bisect-limit=2 PowerParser.cc -c -O1 -g -o b.o

# 133 vs 137(g)
#clang++ -mllvm -opt-bisect-limit=130 PowerParser.cc -c -O1 -o a.o
#clang++ -mllvm -opt-bisect-limit=134 PowerParser.cc -c -O1 -g -o b.o
clang++ -S -mllvm -opt-bisect-limit=133 PowerParser.cc -c -O1 -o - 1>a.o 2>&1
clang++ -S -mllvm -opt-bisect-limit=137 PowerParser.cc -c -O1 -g -o - 1>b.o 2>&1
