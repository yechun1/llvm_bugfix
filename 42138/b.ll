...
define dso_local void @_ZN1k1lEv(%class.k* %0) local_unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !13 {
  ...
  invoke void @_ZN1eIciEC1EPc9allocator(%class.e* nonnull %2, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i64 0, i64 0), %class.allocator* nonnull %3)
          to label %6 unwind label %14, !dbg !72
...
6:                                                ; preds = %1
  ...
  %10 = getelementptr inbounds %class.k, %class.k* %0, i64 0, i32 1, !dbg !74
  br label %11, !dbg !75

11:                                               ; preds = %13, %6
  call void @llvm.dbg.value(metadata i32 0, metadata !49, metadata !DIExpression()), !dbg !76
  %12 = call zeroext i1 @_ZN1k5m_fn4Ev(%class.k* %0), !dbg !77
  br i1 %12, label %13, label %16, !dbg !79

13:                                               ; preds = %22, %11
  br label %11, !dbg !76, !llvm.loop !80
...
14:                                               ; preds = %1
  ...
  resume { i8*, i32 } %15, !dbg !83

16:                                               ; preds = %11, %22
  call void @llvm.lifetime.start.p0i8(i64 1, i8* nonnull %7) #5, !dbg !84
  %17 = load i32, i32* %10, align 4, !dbg !85, !tbaa !86
  %18 = load i32, i32* @h, align 4, !dbg !91, !tbaa !92
  %19 = load i32, i32* @i, align 4, !dbg !93, !tbaa !92
  call void @llvm.dbg.value(metadata %class.f* %4, metadata !53, metadata !DIExpression(DW_OP_deref)), !dbg !74
  call void @_ZN1fC1EPiS0_iiii(%class.f* nonnull %4, i32* nonnull %8, i32* nonnull %9, i32 %17, i32 %18, i32 %19, i32 0), !dbg !94
  call void @llvm.dbg.value(metadata %class.f* %4, metadata !53, metadata !DIExpression(DW_OP_deref)), !dbg !74
  call void @_ZN1f1gEv(%class.f* nonnull %4), !dbg !95
  %20 = call zeroext i1 @_ZeqIPKcciEb1eIT0_T1_ET_(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i64 0, i64 0)), !dbg !97
  br i1 %20, label %21, label %22, !dbg !98
...
22:                                               ; preds = %21, %16
  ...
  %23 = call zeroext i1 @_ZN1k5m_fn4Ev(%class.k* nonnull %0), !dbg !77
  br i1 %23, label %13, label %16, !dbg !79, !llvm.loop !102
}
...
declare dso_local void @_ZN1fC1EPiS0_iiii(%class.f*, i32*, i32*, i32, i32, i32, i32) unnamed_addr #2
...
!85 = !DILocation(line: 33, column: 22, scope: !54)
!86 = !{!87, !88, i64 4}
!87 = !{!"_ZTS1k", !88, i64 0, !88, i64 4, !88, i64 8, !88, i64 12}
!88 = !{!"int", !89, i64 0}
!89 = !{!"omnipotent char", !90, i64 0}
!90 = !{!"Simple C++ TBAA"}
!91 = !DILocation(line: 33, column: 25, scope: !54)
!92 = !{!88, !88, i64 0}
!93 = !DILocation(line: 33, column: 28, scope: !54)
