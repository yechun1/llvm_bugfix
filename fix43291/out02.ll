...
define i16 @bar() {
  ...
  %alloca_b.i = alloca [3 x i32]
  %alloca_c.i = alloca i32
  %1 = bitcast i32* %alloca_a.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %1)
  %2 = bitcast [3 x i32]* %alloca_b.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* %2)
  %3 = bitcast i32* %alloca_c.i to i8*
  ...
  %4 = bitcast i32* %alloca_a.i to i8*
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %4)
  %5 = bitcast [3 x i32]* %alloca_b.i to i8*
  call void @llvm.lifetime.end.p0i8(i64 12, i8* %5)
  %6 = bitcast i32* %alloca_c.i to i8*
